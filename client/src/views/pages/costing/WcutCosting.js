...
const Costing = () => {
    ...
    const [lenght, setLenght] = useState(22);
    const [gusset, setGusset] = useState(6);
    const [gsm, setGsm] = useState(30);
    const [wastage, setWastage] = useState(18);
    const [fabricp, setFabricp] = useState(370);
    const [cmt, setCmt] = useState(30);
    const [packing, setPacking] = useState(5);
    const [printing, setPrinting] = useState(0);
    const [wastagerec, setWastagerec] = useState(-130);
    const [overheads, setOverheads] = useState(2);
    ...
    const fabricreq = ((width+gusset)*2)+1.5;
